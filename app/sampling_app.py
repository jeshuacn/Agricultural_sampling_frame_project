...
#App settings
st.set_page_config(page_title='Agricultural Sampling', page_icon='🌻',layout='wide')
...
@st.cache
def load_data():
  df=pd.read_excel('https://github.com/jeshuacn/Agricultural_sampling_frame_project/blob/main/app/Sampling%20Frame%20dataset.xlsx',index_col= 'ID')
